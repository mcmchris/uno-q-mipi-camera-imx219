...
# Resolución MID (Binning)
FMT="fmt:SRGGB10_1X10/1640x1232"

# ==========================================
# RUTA 0: CSI0 -> RAW RDI0
# ==========================================
echo "Soldando RUTA 0 (CSI0 -> RDI0) a 1640x1232..."
...
# ==========================================
echo "Soldando RUTA 1 (CSI1 -> RDI0 en VFE1) a 1640x1232..."
...
echo "¡Hardware DUAL IMX219 (MID) enrutado exitosamente!"